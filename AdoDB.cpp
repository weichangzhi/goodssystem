...
BOOL CADODataset::GetCollect(LPCTSTR strFieldName, CString &strValue)
{
...
void CADODataset::FreeMem(void *lpMem)
{
	if (NULL != lpMem)
	{
		free(lpMem);
